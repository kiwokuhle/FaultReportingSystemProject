 ...
 * @author 212104756
 */
@WebServlet(name = "addResidenceServlet", urlPatterns = {"/addResidenceServlet"})
public class addResidenceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao= new DAO();
        String dispatch="addResidence.jsp";
        ...
        try
        {
            ...
            if(errors.isEmpty()){
                ...
                boolean isAdded=dao.addResidence(newResidence);
                if(isAdded)
                {
                    System.out.println("is Added");
                    request.setAttribute("successMsg", "Residence named "+ rezName+" "+roomNo+" "+faultDescription+" "+date+" "+id+" "+"inserted");
                    dispatch="listResidence.jsp";
                
                }
                else
                {
                    errors.add("Residence not inserted");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(addResidenceServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
